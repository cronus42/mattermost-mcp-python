...
class ReactionResource(BaseMCPResource):
            ...
            for channel_id in channels_to_read:
                try:
                    ...
                    for post_data in posts_data["posts"].values():
                        ...
                        try:
                            reactions_data = await self._http_client.get(f"/posts/{post_id}/reactions")
                            ...
                            logger.debug("Failed to get reactions for post", post_id=post_id, error=str(e))
    ...
    async def _start_streaming(self, **kwargs) -> None:
        ...
        self._ws_client.on_event("reaction_removed", self._handle_reaction_removed_event)
    ...
    def _handle_reaction_added_event(self, event_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.error("Error handling reaction added event", error=str(e), exc_info=True)
    ...
    def _handle_reaction_removed_event(self, event_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.error("Error handling reaction removed event", error=str(e), exc_info=True)
    ...
    async def _poll_channel_reactions(self, channel_id: str, current_reactions: Set[str]) -> None:
