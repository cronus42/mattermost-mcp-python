...
class AsyncHTTPClient:
    ...
    async def _make_request_with_retries(
        ...
        for attempt in range(self.max_retries + 1):
            try:
                ...
                if attempt < self.max_retries and response.status_code in self.retry_on_status:
    ...
    async def post(
        ...
        """Make a POST request."""
        return await self.request('POST', endpoint, data=data, json=json, params=params, headers=headers)
    ...
    async def put(
        ...
        """Make a PUT request."""
        return await self.request('PUT', endpoint, data=data, json=json, params=params, headers=headers)
    ...
    async def patch(
        ...
        return await self.request('PATCH', endpoint, data=data, json=json, params=params, headers=headers)
