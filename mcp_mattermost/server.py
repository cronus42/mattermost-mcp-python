...
class MattermostMCPServer:
    ...
    def __init__(
        ...
        self._resource_update_callback: Optional[Callable[[ResourceUpdate], None]] = None
    ...
    def set_resource_update_callback(self, callback: Callable[[ResourceUpdate], None]) -> None:
    ...
    def _handle_resource_update(self, update: ResourceUpdate) -> None:
        ...
        resource_type = update.resource_uri.split('/')[-1] if '/' in update.resource_uri else update.resource_uri
