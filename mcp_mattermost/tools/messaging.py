...
async def update_message(
    ...
    patch_data = PostPatch(message=message, file_ids=file_ids, props=props)
...
async def delete_message(
    post_id: str, services: Optional[Dict[str, Any]] = None
) -> Dict[str, str]:
    """
    Delete a message.
...
async def get_thread(
    root_post_id: str, services: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    """
...
@mcp_tool(
    ...
    input_schema={
        ...
        "properties": {
            ...
            "since": {"type": "integer", "description": "Get posts since timestamp"},
            "before": {
                "type": "string",
                "description": "Get posts before this post ID",
            },
            "after": {"type": "string", "description": "Get posts after this post ID"},
        },
        "required": ["channel_id"],
    },
)
