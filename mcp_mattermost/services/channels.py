...
class ChannelsService(BaseService):
    ...
    async def update_channel(self, channel_id: str, channel_patch: ChannelPatch) -> Channel:
        """
    ...
    async def patch_channel(self, channel_id: str, channel_patch: ChannelPatch) -> Channel:
        """
    ...
    async def get_public_channels_for_team(
        ...
        return await self._get_list(f"teams/{team_id}/channels/public", Channel, params=params)
    
    async def search_channels(self, team_id: str, search_data: ChannelSearch) -> List[Channel]:
        """
    ...
    async def add_channel_member(self, channel_id: str, user_id: str) -> ChannelMember:
        ...
        return await self._post(f"channels/{channel_id}/members", ChannelMember, data=data)
    ...
    async def get_channel_member(self, channel_id: str, user_id: str) -> ChannelMember:
        ...
        Returns:
            Channel membership information
        """
        return await self._get(f"channels/{channel_id}/members/{user_id}", ChannelMember)
    ...
    async def get_channel_members(
        ...
        """
        params = self._build_query_params(page=page, per_page=per_page)
        return await self._get_list(f"channels/{channel_id}/members", ChannelMember, params=params)
    
    async def remove_channel_member(self, channel_id: str, user_id: str) -> MattermostResponse:
        """
        ...
        Returns:
            Response indicating success
        """
        return await self._delete(f"channels/{channel_id}/members/{user_id}", MattermostResponse)
    ...
    async def get_channel_unread(self, user_id: str, channel_id: str) -> ChannelUnread:
        ...
        """
        return await self._get(f"users/{user_id}/channels/{channel_id}/unread", ChannelUnread)
