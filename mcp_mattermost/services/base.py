...
from ..api.exceptions import HTTPError, AuthenticationError, RateLimitError
...
class BaseService:
    ...
    async def _get(
        ...
        """Make a GET request."""
        return await self._make_request("GET", endpoint, response_model, params=params, headers=headers)
    ...
    async def _get_list(
        ...
        return await self._make_list_request("GET", endpoint, item_model, params=params, headers=headers)
    ...
    async def _post(
        ...
        """Make a POST request."""
        return await self._make_request("POST", endpoint, response_model, data=data, params=params, headers=headers)
    ...
    async def _put(
        ...
        """Make a PUT request."""
        return await self._make_request("PUT", endpoint, response_model, data=data, params=params, headers=headers)
    ...
    async def _patch(
        ...
        return await self._make_request("PATCH", endpoint, response_model, data=data, params=params, headers=headers)
    ...
    async def _delete(
        ...
        return await self._make_request("DELETE", endpoint, response_model, params=params, headers=headers)
