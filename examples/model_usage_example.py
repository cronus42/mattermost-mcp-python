...
from mcp_mattermost.models import (  # User models; Team models; Channel models; Post models; Response models; Auth models
    AccessToken,
    Channel,
    ChannelCreate,
    ChannelMember,
...
def demonstrate_user_operations():
    ...
    user_data = {
        ...
        "mfa_active": False,
        "locale": "en-US",
        "timezone": {"use_auto_timezone": True, "auto_timezone": "America/New_York"},
        "notify_props": {
            "email": "true",
            "desktop": "mention",
            "push": "mention",
